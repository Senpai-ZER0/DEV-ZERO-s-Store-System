...
---
Добавлена базовая поддержка ванильной продажи корабля SCC Zeus MKI через Economy / GridsForSale.
Важно: это поддержка именно ванильной покупки корабля у экономических фракций. Продажа кораблей через кастомный NPC Store Block будет добавляться отдельным этапом.
